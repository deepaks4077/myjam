...
//TODO: Use google-web-components
...
angular.module('myjamApp', [
  ...
  .factory('searchYoutubeService', function ($scope, $http, $window, $sce, $log, VideosService) {
    function init() {
  ...
  .factory('VideosService',function ($window, $rootScope, $log) {
    var service = this;
